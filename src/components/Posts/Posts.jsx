...
//             <button onClick={() => handleMoreClick(post.id)}><Link to={`/posts/${post.id}`}>Details</Link></button>
...
// link bilan yozilgan more sozi <h4></h4> da yozilgan sozni yonida turishi kerak 
